...
n = pypsa.Network('case_1a_opt.nc') #Load network from netcdf file
...
if Should_MAA:
    ...
    plt.suptitle('MAA Analysis of island with area constraint', fontsize = 18)
    plt.title(f'With MGA slack = {mga_slack} \
              Elasped time: {time:.0f} Seconds', fontsize = 10)
